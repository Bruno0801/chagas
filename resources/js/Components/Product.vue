...
<template>
  ...
  <article class="col-span-3 hover:-translate-y-2 duration-300">
    <Link
      href=""
      class="flex flex-col gap-1 h-full "
    >
    <img
      class="h-72 w-full object-cover rounded-xl border border-red-500"
    ...
    <div class="flex flex-row justify-between">
      ...
      <p class="text-sm font-semibold">R$ 500,00</p>
    </div>
    </Link>
  </article>
